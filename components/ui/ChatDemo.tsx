...
const SCRIPT: Step[] = [
  ...
  { role: 'assistant', text: 'Доброго дня! 👋 Заміна екрана iPhone 13 — від 6 900 ₴. Є оригінал і якісна копія на вибір, обслуговування зазвичай 30–60 хвилин.' },
  { role: 'user', text: 'А ви самі заберете телефон? Я на Олексіївці' },
  { role: 'assistant', text: 'Так, звісно! 🚚 Кур’єр безкоштовно забере телефон на Олексіївці й привезе обслужений. Діагностика теж безкоштовна.' },
