...
const PARTICLES: [number, number, number, number, string][] = [
  [14, 4, 13, 0, 'rgba(34,211,238,0.55)'],
  [30, 3, 16, 3, 'rgba(139,92,246,0.5)'],
  [47, 5, 14, 6, 'rgba(251,113,133,0.45)'],
  [63, 3, 18, 1.5, 'rgba(34,211,238,0.45)'],
  [79, 4, 15, 4.5, 'rgba(139,92,246,0.5)'],
  [90, 3, 17, 7, 'rgba(251,191,36,0.4)'],
];
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{
          background:
            'conic-gradient(from 0deg, rgba(34,211,238,0.18), rgba(139,92,246,0.22), rgba(251,113,133,0.16), rgba(34,211,238,0.18))',
