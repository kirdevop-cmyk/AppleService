...
const PARTICLES: [number, number, number, number, string][] = [
  [14, 4, 13, 0, 'rgba(167,139,250,0.55)'],
  [30, 3, 16, 3, 'rgba(139,92,246,0.5)'],
  [47, 5, 14, 6, 'rgba(124,58,237,0.5)'],
  [63, 3, 18, 1.5, 'rgba(167,139,250,0.45)'],
  [79, 4, 15, 4.5, 'rgba(139,92,246,0.5)'],
  [90, 3, 17, 7, 'rgba(124,58,237,0.45)'],
];
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{
          background:
            'conic-gradient(from 0deg, rgba(167,139,250,0.18), rgba(139,92,246,0.24), rgba(124,58,237,0.18), rgba(167,139,250,0.18))',
      ...
      <div className="animate-blob-2 absolute left-[6%] top-[42%] h-[380px] w-[380px] rounded-full bg-[radial-gradient(circle,rgba(167,139,250,0.22),transparent_62%)] blur-2xl" />
      <div className="animate-blob absolute right-[34%] top-[58%] h-[300px] w-[300px] rounded-full bg-[radial-gradient(circle,rgba(124,58,237,0.18),transparent_62%)] blur-2xl [animation-delay:-7s]" />
