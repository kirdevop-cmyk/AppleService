...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'MobiDoctor — майстерня виїзного ремонту смартфонів у Харкові. Кур’єр забирає й привозить телефон, гарантія до 12 місяців, чесні ціни. ☎ 073 666 18 36',
  path: '/pro-nas',
});
    ...
    <>
      ...
      <section className="pt-16">
        <div className="container-x py-12">
          ...
          <p className="mb-7 max-w-2xl text-lg text-ash">Ми зробили ремонт смартфонів зручним: без черг і поїздок через усе місто. Кур’єр приїде до вас.</p>
          <PageActions />
        </div>
      </section>
      <Section>
        <div className="prose-x max-w-3xl">
          ...
          <p>MobiDoctor — це майстерня <strong>виїзного ремонту смартфонів у Харкові</strong>. Наша головна перевага перед стаціонарними майстернями — комфорт клієнта: вам не потрібно нікуди їхати. Кур’єр безкоштовно забирає телефон, ми ремонтуємо в обладнаній майстерні (паяльні станції, мікроскопи) і привозимо девайс назад готовим.</p>
          ...
          <ul>
            ...
            <li>Ремонт будь-якої складності: від заміни екрана до плати.</li>
          </ul>
