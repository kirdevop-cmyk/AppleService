...
export const metadata: Metadata = buildMetadata({
  title: 'Гарантія на обслуговування смартфонів | MobiDoctor Харків',
  description:
    'Гарантія до 12 місяців на обслуговування смартфонів у MobiDoctor: на роботи та встановлені деталі, з гарантійним талоном. Умови гарантії. ☎ 073 666 18 36',
  path: '/garantiya',
});
    ...
    <>
      ...
      <section className="pt-16">
        <div className="container-x py-12">
          ...
          <h1 className="mb-4 text-3xl font-medium tracking-tight sm:text-4xl">Гарантія на обслуговування</h1>
      ...
      <Section>
        <div className="prose-x max-w-3xl">
          ...
          <ul>
            ...
            <li>Окремі складні обслуговування (після води, плата) — строк узгоджується індивідуально й вказується в талоні.</li>
          </ul>
          <h2>Коли гарантія не діє</h2>
          <ul>
            <li>Механічні пошкодження після обслуговування (падіння, удар, тиск).</li>
            <li>Потрапляння вологи після обслуговування.</li>
            <li>Самостійне втручання або обслуговування в іншому місці після нас.</li>
