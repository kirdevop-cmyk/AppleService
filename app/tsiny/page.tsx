...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'Орієнтовні ціни на ремонт смартфонів у Харкові: заміна екрана, акумулятора, після води, роз’єм зарядки. Діагностика та виїзд кур’єра — безкоштовно. ☎ 073 666 18 36',
  path: '/tsiny',
});
    ...
    <>
      ...
      <section className="pt-16">
        <div className="container-x py-12">
          ...
          <h1 className="mb-4 max-w-3xl text-3xl font-medium leading-tight tracking-tight sm:text-4xl">
            Ціни на ремонт смартфонів у Харкові
          </h1>
      ...
      <Section>
        ...
        <div className="prose-x mt-8 max-w-3xl">
          ...
          <p>Ми завжди узгоджуємо вартість ремонту <strong>до початку робіт</strong> — після безкоштовної діагностики. Жодних сюрпризів у підсумковому чеку. Пропонуємо деталі на вибір: <strong>оригінал</strong> (дорожче, максимальна якість) або <strong>сертифікована копія</strong> (дешевше, з гарантією). На все — гарантія до 12 місяців.</p>
        </div>
